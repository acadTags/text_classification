...
class TextRNN:
    ...
    def inference(self):
        ...
        #self.output_rnn_last=tf.reduce_mean(output_rnn,axis=1) #[batch_size,hidden_size*2] # this is average pooling of hidden states
        output_rnn_last=output_rnn[:,-1,:] ##[batch_size,hidden_size*2] # this used the last hidden state as the representation of the document
